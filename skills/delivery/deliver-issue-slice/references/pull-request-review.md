...
6. Apply valid production findings through the existing Implementor and valid test findings through its matching Tester under [worker continuity](../../delivery-runtime-protocol/references/worker-continuity.md). Reject invalid or out-of-scope findings with concise evidence.
