<!-- Synced from skills/delivery/delivery-runtime-protocol/references/review-artifacts.md by scripts/sync-plugin-references.sh. Edit the source, not this copy. -->
