...
6. Apply valid production findings through the existing Implementor and valid test findings through its matching Tester under same-issue worker continuity. Reject invalid or out-of-scope findings with concise evidence.
